...
# Long-term by region and season  


```{r, results = "asis", fig.width = 5, fig.height = 8}
...
for(i in seq_along(parms)){
  ...
  p1 <- ggplot(tmp_seas) +
    ...
    geom_vline(xintercept = 0,
               linewidth = 1) +
    theme(legend.position = "none") +
    labs(title = paste0(parms[i], " slopes by season"))
