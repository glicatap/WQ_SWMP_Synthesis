...
# medians
# wq/nut
medians_wqnut <- read.csv(here::here("Outputs", "WQ-NUT_overallMedians.csv"))

# met
medians_met <- read.csv(here::here("Outputs", "MET_overallMedians.csv"))

# seasonal amplitude
medians_seasonality <- read.csv(here::here("Outputs", "seasonal_amplitude_medians.csv"))


# long-term trends
# wq/nut/met
trends_wqnutmet <- read.csv(here::here("Outputs", "calculated_trends", "long-term-trends.csv"))

# seasonal amplitude
trends_seasonality <- read.csv(here::here("Outputs", "seasonal_amplitude_medians.csv"))
...
```{r}
write.csv(all_predictors, here::here("Outputs", "compiled_predictors.csv"),
          row.names = FALSE,
          na = "")
```
...
write.csv(doLT2, here::here("Outputs", "doLT2_compiled_predictors.csv"),
          row.names = FALSE,
          na = "")
```
