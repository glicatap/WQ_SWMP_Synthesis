...
write.csv(all_medians, file = here::here("Outputs", "seasonal_amplitude_medians.csv"))

saveRDS(all_estimates, file = here::here("Outputs", "calculated_trends",
                                         "seasonal_amplitude_trends.rds"))
write.csv(all_estimates, file = here::here("Outputs", "seasonal_amplitude_trends.csv"))
```
