...
preds_df$possibly_influential[infls] <- TRUE
...
preds_df_long <- preds_df |> 
    pivot_longer(tpld_PC1:precp_trend,
                 names_to = "predictor",
                 values_to = "value")

cbind("station" = dat_all$station[infls], dat_domgl[infls, c("no23_median.log", "turb_trend", "precp_trend", "tpld_PC1")], "Pearson residual" = preds_df$resids[infls])
