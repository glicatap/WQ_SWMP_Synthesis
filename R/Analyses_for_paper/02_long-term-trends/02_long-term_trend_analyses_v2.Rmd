...
source(here::here("helper_files", "functions_v2.R"))
...
for(i in 1:nrow(wq_grid)){
  ...
  if(exists("bam_out")){
    ...
    file_out <- here::here("Outputs", "02_calculated_long-term-trends", "bam_outputs_v2",
...
for(i in 1:nrow(do_grid)){
  ...
  if(exists("bam_out")){
    ...
    # save the entire bam object, including autocorrelation info
    file_out <- here::here("Outputs", "02_calculated_long-term-trends", "bam_outputs",
                           paste0(stn, "_", param, "_bam.RData"))
    save(bam_out, file = file_out)
