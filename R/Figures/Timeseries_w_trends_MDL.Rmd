...
ggplot()+
    ...
    geom_abline(data = trends, aes(intercept = po4f_mdl_intcpt, slope = po4f_mdl_trend,
                                   group=station,color=reserve), linetype = "dashed",
                linewdith=2) +
    facet_wrap(~reserve,scales="free")+theme(legend.position = "none")+
    ggtitle("log(po4f)")
...
ggplot()+
    ...
    geom_abline(data = trends, aes(intercept = nh4f_mdl_intcpt, slope = nh4f_mdl_trend,
                                   group=station,color=reserve), linetype = "dashed",
                linewdith=2) +
    facet_wrap(~reserve,scales="free")+theme(legend.position = "none")+
    ggtitle("log(nh4f)")
...
ggplot()+
    ...
    geom_abline(data = trends, aes(intercept = no23f_mdl_intcpt, slope = no23f_mdl_trend,
                                   group=station,color=reserve), linetype = "dashed",
                linewdith=2) +
    facet_wrap(~reserve,scales="free")+theme(legend.position = "none")+
    ggtitle("log(no23f)")
