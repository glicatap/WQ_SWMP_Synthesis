...
```{r}
# base figure width and height on the type of data
figwidth <- ifelse(params$dataType == "nut", 7, 7)
figheight <- ifelse(params$dataType == "nut", 7, 6)
```


```{r, eval = TRUE, echo = TRUE, results = 'asis', fig.width = figwidth, fig.height = figheight}
